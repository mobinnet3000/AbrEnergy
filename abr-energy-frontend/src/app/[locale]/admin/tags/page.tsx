...
export default function AdminTagsPage() {
  ...
  useEffect(() => { if (error) toast.error('Failed to load tags'); }, [error]);
  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <Card>
          <CardHeader><CardTitle>All Tags ({items.length})</CardTitle></CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead><tr className="border-b text-left"><th className="py-3 px-2">Title</th><th className="py-3 px-2">Slug</th></tr></thead>
                <tbody>
