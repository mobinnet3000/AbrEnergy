...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!user) return <div className="flex items-center justify-center min-h-screen text-muted-foreground">Loading...</div>;
    ...
    <div className="min-h-[80vh] flex flex-col lg:flex-row">
      <aside className="lg:w-64 border-b lg:border-b-0 lg:border-r bg-gray-50 dark:bg-gray-900 p-4 flex flex-col">
        ...
        <div className="space-y-2 pt-4 border-t">
          <Link href="/">
            <Button variant="outline" size="sm" className="w-full">Back to Site</Button>
          </Link>
          <Button
            type="button"
            variant="ghost"
